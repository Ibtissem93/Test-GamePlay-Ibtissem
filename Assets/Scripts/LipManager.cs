...
public class LipManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        parts.Add(head);
        cameraToCone = Vector3.Distance(camera.transform.position, head.position);
    ...
    public void AddPartt(string name)
    {
        Vector3 spawnPosition = new Vector3(transform.position.x, transform.position.y, parts.Count * +distance);
        switch (name)
        {
